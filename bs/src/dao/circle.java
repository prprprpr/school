...
public class circle {
	...
	public point circumCenter(point a,point b,point c){
		double a1=b.getX()-a.getX(),b1=b.getY()-a.getY(),c1=(a1*a1+b1*b1)/2;
		double a2=c.getX()-a.getX(),b2=c.getY()-a.getY(),c2=(a2*a2+b2*b2)/2;
		double d=a1*b2-a2*b1;
		double x=a.getX()+(c1*b2-c2*b1)/d;
		double y=a.getY()+(a1*c2-a2*c1)/d;
